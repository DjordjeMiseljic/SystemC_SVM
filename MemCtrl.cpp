   ...
   while(1)
	{
		...
		sv_num = num_of_sv();
		string y_line;
		ifstream y_file("/home/fouste/SVM/ML_number_recognition_SVM/saved_data/test_images/y.txt");
		ifstream sv_file("/home/fouste/SVM/ML_number_recognition_SVM/saved_data/support_vectors/sv0.txt");
		ifstream l_file("/home/fouste/SVM/ML_number_recognition_SVM/saved_data/lambdas/lambdas0.txt");
		ifstream t_file("/home/fouste/SVM/ML_number_recognition_SVM/saved_data/targets/target0.txt");
