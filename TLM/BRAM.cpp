...
{
   s_br_t0.register_b_transport(this, &BRAM::b_transport1);
   s_br_t1.register_b_transport(this, &BRAM::b_transport1);
   cout<<name<<" constructed"<<endl;
   
   mem.reserve(2*SV_LEN);
}

void BRAM::b_transport1(pl_t& pl, sc_time& offset)
{
